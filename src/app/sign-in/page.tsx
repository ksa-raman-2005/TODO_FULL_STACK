        ...
        <Card className="relative w-full border border-white/10 bg-gray-950/70 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden text-gray-100">
          ...
          <CardHeader className="space-y-2 pt-8 px-8 relative overflow-hidden">
            ...
            <CardDescription className="text-gray-400 text-sm leading-relaxed">
              Enter your access credentials to authenticate into your control suite.
            </CardDescription>
          </CardHeader>
          ...
          <form onSubmit={submit}>
              ...
              <div className="space-y-2 group/field">
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={isLoading}
                    required
                    className="h-12 bg-gray-900/40 border-white/10 text-white placeholder:text-gray-600 rounded-xl px-4 transition-all duration-300 focus-visible:ring-0 focus-visible:ring-offset-0 focus:border-purple-500 focus:shadow-[0_0_15px_rgba(168,85,247,0.15)] disabled:opacity-50"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 group/field">
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled={isLoading}
                    required
                    className="h-12 bg-gray-900/40 border-white/10 text-white placeholder:text-gray-600 rounded-xl pl-4 pr-12 transition-all duration-300 focus-visible:ring-0 focus-visible:ring-offset-0 focus:border-purple-500 focus:shadow-[0_0_15px_rgba(168,85,247,0.15)] disabled:opacity-50"
                  />
                  <button
                    type="button"
            ...
            <CardFooter className="flex flex-col space-y-5 pb-8 pt-4 px-8 relative">
              <Button 
                type="submit" 
                className="w-full h-12 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 text-white font-semibold rounded-xl border border-white/10 shadow-lg shadow-purple-500/10 hover:shadow-purple-500/20 transition-all duration-300 hover:brightness-110 active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none" 
                disabled={isLoading}
              >
                {isLoading ? (
              ...
              <p className="text-sm text-center text-gray-400">
                Lacking interface access?{" "}
                <Link href="/sign-up" className="font-medium text-purple-400 hover:text-purple-300 transition-colors relative group/link">
                  Create Account
